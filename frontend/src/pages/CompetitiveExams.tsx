...
import { Search, BookOpen, FileText, Clock, ChevronDown, ChevronUp, Trophy } from 'lucide-react';
...
const examCategories = [
  {
    ...
    emoji: '⚙️',
    exams: [
      { name: 'JEE Mains', desc: 'Joint Entrance Examination - Mains', students: '12L+' },
      { name: 'JEE Advanced', desc: 'Joint Entrance Examination - Advanced', students: '2.5L+' },
      { name: 'BITSAT', desc: 'BITS Pilani Admission Test', students: '3L+' },
      { name: 'VITEEE', desc: 'VIT Engineering Entrance Exam', students: '2L+' },
      { name: 'MHT CET', desc: 'Maharashtra Common Entrance Test', students: '4L+' },
      { name: 'WBJEE', desc: 'West Bengal Joint Entrance Exam', students: '1.5L+' },
    ],
  },
  {
    ...
    emoji: '🏥',
    exams: [
      { name: 'NEET UG', desc: 'National Eligibility cum Entrance Test', students: '20L+' },
      { name: 'NEET PG', desc: 'NEET Postgraduate', students: '2L+' },
      { name: 'AIIMS', desc: 'All India Institute of Medical Sciences', students: '5L+' },
      { name: 'JIPMER', desc: 'Jawaharlal Institute Entrance Exam', students: '1L+' },
    ],
  },
  {
    ...
    emoji: '🏛️',
    exams: [
      { name: 'UPSC IAS', desc: 'Indian Administrative Service', students: '10L+' },
      ...
      { name: 'State PSC', desc: 'State Public Service Commission', students: '15L+' },
    ],
  },
  {
    category: 'SSC Exams',
    ...
    exams: [
      ...
      { name: 'SSC CHSL', desc: 'Combined Higher Secondary Level', students: '25L+' },
      { name: 'SSC MTS', desc: 'Multi Tasking Staff', students: '20L+' },
      { name: 'SSC GD', desc: 'General Duty Constable', students: '40L+' },
      { name: 'SSC CPO', desc: 'Central Police Organisation', students: '15L+' },
  ...
  },
  {
    ...
    exams: [
      ...
      { name: 'SBI Clerk', desc: 'State Bank of India Clerk', students: '20L+' },
      { name: 'RBI Grade B', desc: 'Reserve Bank of India', students: '5L+' },
      { name: 'NABARD', desc: 'National Bank for Agriculture', students: '2L+' },
    ],
  },
  {
    ...
    emoji: '🚂',
    exams: [
      { name: 'RRB NTPC', desc: 'Non-Technical Popular Categories', students: '35L+' },
      ...
      { name: 'RPF Constable', desc: 'Railway Protection Force', students: '8L+' },
    ],
  },
  {
    ...
    emoji: '👮',
    exams: [
      { name: 'Bihar Police', desc: 'Bihar Police Constable', students: '10L+' },
      { name: 'UP Police', desc: 'Uttar Pradesh Police', students: '25L+' },
      { name: 'MP Police', desc: 'Madhya Pradesh Police', students: '8L+' },
      { name: 'Rajasthan Police', desc: 'Rajasthan Police Constable', students: '6L+' },
  ...
  },
  {
    ...
    emoji: '👩‍🏫',
    exams: [
      { name: 'CTET', desc: 'Central Teacher Eligibility Test', students: '30L+' },
      { name: 'STET', desc: 'State Teacher Eligibility Test', students: '15L+' },
  ...
  },
  {
    ...
    emoji: '🎖️',
    exams: [
      { name: 'AFCAT', desc: 'Air Force Common Admission Test', students: '3L+' },
  ...
  },
  {
    ...
    emoji: '📊',
    exams: [
      { name: 'LIC AAO', desc: 'Life Insurance Corporation AAO', students: '5L+' },
      { name: 'NICL AO', desc: 'National Insurance Company AO', students: '2L+' },
      { name: 'EPFO', desc: 'Employees Provident Fund Organisation', students: '3L+' },
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-4 hover:shadow-glass transition-all duration-200">
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={() => toast.info(`Opening previous year papers for ${name}...`)}
...
export default function CompetitiveExams() {
  ...
  const totalExams = examCategories.reduce((sum, cat) => sum + cat.exams.length, 0);
      ...
      <div className="gradient-hero px-4 pt-6 pb-12">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="font-baloo font-bold text-2xl text-white">Competitive Exams</h1>
              <p className="text-white/60 text-sm">{totalExams}+ Exams • 100% Free Study Material</p>
            </div>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-semibold text-foreground text-sm">{cat.category}</div>
                  <div className="text-foreground/50 text-xs">{cat.exams.length} exams</div>
                </div>
              </div>
