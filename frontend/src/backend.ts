...
import type { StudentView as _StudentView, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStudent(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveQuizScore(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStreak(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudentView]): StudentView | null {
    return value.length === 0 ? null : value[0];
}
